    ...
    <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
        ...
        <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm'>
            <input
             ...
             type="text" name="search" id="search"  placeholder={placeholder || 'Start your search'} className='pl-5 bg-transparent outline-none flex-1 text-sm text-gray-600 placeholder-gray-400'/>
